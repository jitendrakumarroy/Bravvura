package com.bravvura.hri.TestBase;
...
import com.bravvura.hri.excelReader.Excel_reader;
...
public class TestBase {
	...
	static {
		...
		extent = new ExtentReports(System.getProperty("user.dir") + "/src/main/java/com/bravvura/hri/reports/test" + formater.format(calendar.getTime()) + ".html", false);	
	}
	...
	public void getBrowser(String browser){
		if(System.getProperty("os.name").contains("Window")){
			if(browser.equalsIgnoreCase("firefox")){
				...
				System.setProperty("webdriver.chrome.driver", "D:\\HRIFrameWork\\HRIFramework\\Driver\\chromedriver.exe");
	...
	public void loadPropertiesFile() throws IOException{
		...
		OR = new Properties();
		f1 = new File(System.getProperty("user.dir")+"/src/main/java/com/bravvura/hri/config/config.properties");
		System.out.println(f1);
		file = new FileInputStream(f1);
		OR.load(file);
		logger.info("loading config.properties");
		
		f1 = new File(System.getProperty("user.dir")+"/src/main/java/com/bravvura/hri/config/or.properties");
		file = new FileInputStream(f1);
		OR.load(file);
		logger.info("loading or.properties");
		
		f1 = new File(System.getProperty("user.dir")+"/src/main/java/com/bravvura/hri/properties/homepage.properties");
		file = new FileInputStream(f1);
		OR.load(file);
	...
	public String getScreenShot(String imageName) throws IOException{
		...
		String imagelocation = System.getProperty("user.dir")+"/src/main/java/com/bravvura/hri/screenshot/";
		Calendar calendar = Calendar.getInstance();
		SimpleDateFormat formater = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss");
	...
	public String[][] getData(String excelName, String sheetName){
		System.out.println(System.getProperty("user.dir"));
		String excellocation = System.getProperty("user.dir")+"/src/main/java/com/bravvura/hri/data/"+excelName;
	...
	public static void updateResultupdateResult(int indexSI,  String screenShotLocation,String response) throws IOException {
		...
		String resultFile = userDirector + "/src/main/java/com/bravvura/hri/screenshot/TestReport.html";
