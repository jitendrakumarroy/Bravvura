package com.bravvura.excelTutorial;
...
import org.apache.poi.xssf.usermodel.XSSFWorkbook;
	...
	public class UpdateTestResultInExcel {
		...
		public static void updateResult(String excellocation, String sheetName, 
				String testCaseName, String testStatus)throws IOException {
		...
		public static void main(String[] args) throws IOException {
			...
			String testpath="D:\\testing.xlsx";
			
			updateResult(testpath, "Test", "tc01", "pass");
		}
}
